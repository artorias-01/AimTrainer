...
export const SCENARIOS: ScenarioDef[] = [
  ...
  {
    id: 'smoothswitch-burst',
    name: 'SMOOTHSWITCH // BURST',
    category: 'switching',
    description: '4 moving targets each requiring 2 hits to destroy. Spray, switch, and re-acquire in a sustained burst rhythm.',
    difficulty: 'Advanced',
    durationSeconds: 60,
    targetCount: 4,
    targetRadius: 0.40,
    ...
    speedVariance: 0.3,
    tags: ['SMOOTHSWITCH', 'BURST', 'MULTI-HIT', 'AUTO-FIRE'],
    recommendedCm360: '25-35 cm',
    iconName: 'Layers',
  },
  {
  ...
  {
    id: 'spray-transfer',
    name: 'SPRAY TRANSFER // HEAVY',
    category: 'switching',
    description: '5 sinusoidal 2-HP targets. Hold fire to bleed each target, then transfer to the next. Trains spray-and-switch rhythm.',
    difficulty: 'Advanced',
    durationSeconds: 60,
    targetCount: 5,
    targetRadius: 0.40,
    ...
    speedVariance: 0.35,
    tags: ['SPRAY TRANSFER', 'SWITCHING', 'MULTI-HIT', 'AUTO-FIRE'],
    recommendedCm360: '25-40 cm',
    iconName: 'Zap',
  },
];
