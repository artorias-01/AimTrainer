...
export const SCENARIOS: ScenarioDef[] = [
  ...
  },
  {
    ...
    name: 'REFLEX // 650MS',
    category: 'switching',
    description: 'Targets flash into existence for 650ms before expiring. Misses logged if target despawns before being hit.',
    difficulty: 'Advanced',
    durationSeconds: 45,
    targetCount: 2,
    targetRadius: 0.4,
  ...
  },
  {
    ...
    category: 'switching',
    description: 'Rapid 2-target pair flicks with strict timing windows (500ms). Builds high-frequency duel acceleration.',
    difficulty: 'Pro',
    durationSeconds: 45,
    targetCount: 2,
    targetRadius: 0.35,
  ...
  },
  {
    ...
    category: 'switching',
    description: 'Ultra-fast 450ms expiration window with 4 concurrent targets. Rewards pure reaction speed and clutch flicking.',
    difficulty: 'Pro',
    durationSeconds: 45,
    targetCount: 4,
    targetRadius: 0.38,
